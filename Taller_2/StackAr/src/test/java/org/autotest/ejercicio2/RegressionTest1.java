...
public class RegressionTest1 {
    ...
    public void test0053() throws Throwable {
        ...
        boolean boolean15 = stackAr10.equals((Object) 1L);
    ...
    public void test0057() throws Throwable {
        ...
        Class<?> wildcardClass9 = stackAr0.getClass();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
    ...
    public void test0061() throws Throwable {
        ...
        String str9 = stackAr5.toString();
        boolean boolean10 = stackAr1.equals((Object) str9);
        // The following exception was thrown during execution in test generation
        try {
    ...
    public void test0065() throws Throwable {
        ...
        Class<?> wildcardClass3 = stackAr0.getClass();
    ...
    public void test0072() throws Throwable {
        ...
        Class<?> wildcardClass55 = stackAr20.getClass();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
    ...
    public void test0079() throws Throwable {
        ...
        stackAr28.push((Object) 'a');
        Object obj31 = stackAr28.top();
        boolean boolean32 = stackAr28.isEmpty();
        String str33 = stackAr28.toString();
        String str34 = stackAr28.toString();
        // The following exception was thrown during execution in test generation
        try {
            stackAr15.push((Object) stackAr28);
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalStateException; message: null");
        } catch (IllegalStateException e) {
            // Expected exception.
        }
    ...
    public void test0083() throws Throwable {
        ...
        int int25 = stackAr20.size();
        boolean boolean26 = stackAr15.equals((Object) stackAr20);
        Class<?> wildcardClass27 = stackAr15.getClass();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
    ...
    public void test0093() throws Throwable {
        ...
        Class<?> wildcardClass14 = stackAr9.getClass();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "[]" + "'", str4, "[]");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
    ...
    public void test0095() throws Throwable {
        ...
        Class<?> wildcardClass8 = stackAr2.getClass();
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 0 + "'", int4 == 0);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
    ...
    public void test0098() throws Throwable {
        ...
        Class<?> wildcardClass19 = stackAr1.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + true + "'", boolean2 == true);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 0 + "'", int3 == 0);
        org.junit.Assert.assertEquals("'" + str6 + "' != '" + "[]" + "'", str6, "[]");
        org.junit.Assert.assertEquals("'" + str11 + "' != '" + "[]" + "'", str11, "[]");
    ...
    public void test0099() throws Throwable {
        ...
        boolean boolean8 = stackAr5.equals((Object) (byte) -1);
        String str9 = stackAr5.toString();
        boolean boolean11 = stackAr5.equals((Object) 10L);
        String str12 = stackAr5.toString();
        Class<?> wildcardClass13 = stackAr5.getClass();
