...
public class RegressionTest4 {
    ...
    public void test0202() throws Throwable {
        ...
        boolean boolean49 = stackAr43.equals((Object) '4');
        ...
        boolean boolean56 = stackAr43.equals((Object) "");
        ...
        boolean boolean61 = stackAr39.equals((Object) stackAr60);
        stackAr33.push((Object) stackAr60);
        // The following exception was thrown during execution in test generation
        try {
            stackAr1.push((Object) stackAr60);
    ...
    public void test0205() throws Throwable {
        ...
        boolean boolean14 = stackAr8.equals((Object) boolean13);
    ...
    public void test0211() throws Throwable {
        ...
        stackAr21.push((Object) wildcardClass28);
        boolean boolean30 = stackAr17.equals((Object) stackAr21);
        stackAr8.push((Object) stackAr21);
        // The following exception was thrown during execution in test generation
        try {
    ...
    public void test0219() throws Throwable {
        ...
        String str23 = stackAr18.toString();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertTrue("'" + boolean10 + "' != '" + false + "'", boolean10 == false);
    ...
    public void test0222() throws Throwable {
        ...
        Class<?> wildcardClass21 = obj20.getClass();
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 0 + "'", int3 == 0);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + true + "'", boolean7 == true);
    ...
    public void test0228() throws Throwable {
        ...
        boolean boolean27 = stackAr15.equals((Object) stackAr19);
        boolean boolean28 = stackAr6.equals((Object) stackAr15);
        boolean boolean30 = stackAr15.equals((Object) 1.0f);
        String str31 = stackAr15.toString();
        org.autotest.StackAr stackAr33 = new org.autotest.StackAr((int) '4');
        int int34 = stackAr33.size();
        String str35 = stackAr33.toString();
        ...
        boolean boolean41 = stackAr33.equals((Object) (byte) -1);
        String str42 = stackAr33.toString();
        boolean boolean43 = stackAr33.isFull();
        boolean boolean45 = stackAr33.equals((Object) 1);
        boolean boolean46 = stackAr15.equals((Object) 1);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + false + "'", boolean7 == false);
        org.junit.Assert.assertEquals("'" + str11 + "' != '" + "[]" + "'", str11, "[]");
    ...
    public void test0232() throws Throwable {
        ...
        boolean boolean17 = stackAr9.equals((Object) (byte) -1);
        stackAr1.push((Object) boolean17);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 0 + "'", int2 == 0);
        org.junit.Assert.assertTrue("'" + int3 + "' != '" + 0 + "'", int3 == 0);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + false + "'", boolean4 == false);
    ...
    public void test0233() throws Throwable {
        ...
        stackAr26.push((Object) stackAr27);
        boolean boolean32 = stackAr23.equals((Object) stackAr27);
        // The following exception was thrown during execution in test generation
        try {
            stackAr1.push((Object) stackAr27);
            org.junit.Assert.fail("Expected exception of type java.lang.IllegalStateException; message: null");
        } catch (IllegalStateException e) {
            // Expected exception.
        }
    ...
    public void test0236() throws Throwable {
        ...
        String str68 = stackAr65.toString();
        boolean boolean69 = stackAr65.isFull();
        stackAr43.push((Object) boolean69);
        boolean boolean71 = stackAr43.isFull();
        String str72 = stackAr43.toString();
        stackAr0.push((Object) str72);
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 0 + "'", int2 == 0);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + true + "'", boolean3 == true);
        org.junit.Assert.assertTrue("'" + int6 + "' != '" + 0 + "'", int6 == 0);
    ...
    public void test0240() throws Throwable {
        ...
        boolean boolean8 = stackAr0.isEmpty();
        boolean boolean10 = stackAr0.equals((Object) '4');
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "[]" + "'", str4, "[]");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
    ...
    public void test0246() throws Throwable {
        ...
        String str30 = stackAr8.toString();
        org.junit.Assert.assertTrue("'" + boolean1 + "' != '" + false + "'", boolean1 == false);
        org.junit.Assert.assertTrue("'" + boolean4 + "' != '" + true + "'", boolean4 == true);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
    ...
    public void test0247() throws Throwable {
        ...
        int int21 = stackAr1.size();
        Class<?> wildcardClass22 = stackAr1.getClass();
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
        org.junit.Assert.assertTrue("'" + int4 + "' != '" + 0 + "'", int4 == 0);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + true + "'", boolean5 == true);
    ...
    public void test0249() throws Throwable {
        ...
        Class<?> wildcardClass38 = stackAr1.getClass();
        org.junit.Assert.assertTrue("'" + int2 + "' != '" + 0 + "'", int2 == 0);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + true + "'", boolean3 == true);
        org.junit.Assert.assertTrue("'" + boolean7 + "' != '" + false + "'", boolean7 == false);
        org.junit.Assert.assertTrue("'" + boolean8 + "' != '" + false + "'", boolean8 == false);
