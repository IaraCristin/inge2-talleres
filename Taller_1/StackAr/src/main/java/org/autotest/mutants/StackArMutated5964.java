 ...
 */
public class StackArMutated5964 extends org.autotest.Stack {
    ...
    public StackArMutated5964() {
        this(org.autotest.mutants.StackArMutated5964.DEFAULT_CAPACITY);
    }

    public StackArMutated5964(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated5964 other = ((org.autotest.mutants.StackArMutated5964) (obj));
        if (true) {
            return false;
        }
