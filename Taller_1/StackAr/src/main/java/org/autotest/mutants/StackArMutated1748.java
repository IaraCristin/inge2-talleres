 ...
 */
public class StackArMutated1748 extends org.autotest.Stack {
    ...
    public StackArMutated1748() {
        this(org.autotest.mutants.StackArMutated1748.DEFAULT_CAPACITY);
    }

    public StackArMutated1748(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated1748 other = ((org.autotest.mutants.StackArMutated1748) (obj));
        if (true) {
            return false;
        }
