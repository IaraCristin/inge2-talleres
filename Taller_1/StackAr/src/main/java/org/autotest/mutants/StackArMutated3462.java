 ...
 */
public class StackArMutated3462 extends org.autotest.Stack {
    ...
    public StackArMutated3462() {
        this(org.autotest.mutants.StackArMutated3462.DEFAULT_CAPACITY);
    }

    public StackArMutated3462(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3462 other = ((org.autotest.mutants.StackArMutated3462) (obj));
        if (true) {
            return false;
        }
